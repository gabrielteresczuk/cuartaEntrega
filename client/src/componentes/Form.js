        ...
        {cargado ? (
          ...
          <div className="Form__cont">
            <form action="post" className="formulario" onSubmit={handleSubmit}>
              ...
              <select className="Form__select" name="categoria" id="categoria" value={form.categoria} onChange={handleChange}>
              ...
              <select className="Form__select" name="subcategoria" id="subcategoria" value={form.subcategoria} onChange={handleChange}>
              ...
              <div className="Form__input__cont">
                <label htmlFor="ranking">Ranking de Estrellas:</label>
                <input
                  onChange={handleChange}
                  value={form.ranking}
                  type="number"
